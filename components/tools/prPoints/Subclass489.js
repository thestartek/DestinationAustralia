...
const Subclass489 = () => {
  ...
  return (
    <ScrollView>
      ...
      Check your points for Skilled Regional (provisional) visa
      </Text>
    ...
    {/* Calculate now */}
      ...
      <Result491 pointsAge={pointsAge} pointsEng={pointsEng} pointsOVemp={pointsOVemp}
      ...
      pointsNaati={pointsNaati} pointsPartner={pointsPartner} pointsSponsor491={pointsSponsor491}/>
    </ScrollView>
  );
};

export default Subclass489;
