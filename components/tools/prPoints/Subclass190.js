  ...
  return (
    <ScrollView>
      <Text style={styles.headingText}>
        Check your points for Skilled Nominated visa
      </Text>
    ...
    {/* Calculate now */}
      ...
      <Result190 pointsAge={pointsAge} pointsEng={pointsEng} pointsOVemp={pointsOVemp}
      ...
      pointsNaati={pointsNaati} pointsPartner={pointsPartner} pointsNomination={pointsNomination}/>
    </ScrollView>
  );
};
