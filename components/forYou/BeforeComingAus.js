    ...
    <ScrollView style={styles.container}>
      ...
      <View style={{ marginHorizontal: 5, marginVertical: 10 }}>
        ...
        <Text style={styles.text}>
          There are several things to consider before coming to Australia. Some
          of the main things to consider are:
        </Text>
        <Text style={styles.text}>
          ...
          Research different{" "}
          {appLink("options for accomodation", "Finding a rental place")}, such
          as student housing, homestays, or renting an apartment.
        </Text>
        ...
        <Text style={styles.text}>
          ...
          Be aware of cultural differences and customs in Australia, as well as
          any cultural or language barriers you may encounter.
        </Text>
